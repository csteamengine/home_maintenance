                ...
                <div class="task-card-main" @click=${()=>this._toggleExpand(s.id)}>
                    ...
                    <div class="task-right">
                        ...
                        <div class="task-actions">
                            <ha-icon-button
                                @click=${i=>{i.stopPropagation(),this._completeTask(s.id,e.completedToday)}}
                                title=${e.completedToday?"Undo completion":"Complete"}
                                ?disabled=${n}
                            >
                                <ha-icon icon=${e.completedToday?"mdi:undo-variant":"mdi:check-circle-outline"}></ha-icon>
                            </ha-icon-button>
                            <ha-icon-button
